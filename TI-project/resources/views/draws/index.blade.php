                                                    ...
                                                    <div class="w-4 mr-2">
                                                        <div x-data="{ showModal: false }">
                                                            ...
                                                            <button @click="showModal = !showModal"
                                                                class="bg-white transition-colors duration-150 ease-linear">
                                                            ...
                                                            <div x-show="showModal"
                                                                ...
                                                                <div x-show="showModal"
                                                                    ...
                                                                    <span class="font-bold block text-2xl mb-3">&#9888;
                                                                        Delete Draw</span>
                                                                    <p class="mb-5">Are you sure you want to delete
                                                                        the draw?</p>
                                                                    <p>All of the data will be permanently removed</p>
                                                                    <!-- Buttons -->
                                                                    <div
                                                                        class="flex justify-end text-right space-x-5 mt-5">
                                                                        <button @click="showModal = !showModal"
                                                                            class="px-4 py-2 text-sm bg-white rounded-xl border transition-colors duration-150 ease-linear border-gray-200 text-gray-500 focus:outline-none focus:ring-0 font-bold hover:bg-gray-50">Cancel</button>
                                                                        <div>
                                                                            <form method="POST"
                                                                                action="/manage-draws/{{ $lottery->id }}">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit" value="Delete"
                                                                                    class="px-4 py-2 text-sm bg-red-600 rounded-xl border transition-colors duration-150 ease-linear border-gray-200 text-white font-bold hover:bg-red-500">Delete</button>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium"
                                                colspan="5">No lotteries found 😥</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
